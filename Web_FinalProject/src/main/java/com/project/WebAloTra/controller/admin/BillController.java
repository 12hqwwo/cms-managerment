...
public class BillController {
    ...
    public String getBill(
        ...
        // ✅ Nếu là STAFF → chỉ lấy bill theo chi nhánh được gán
        if (authentication != null && authentication.getAuthorities().stream()
                .anyMatch(r -> r.getAuthority().equals("ROLE_STAFF"))) {

            String email = authentication.getName();
            Long branchId = accountRepository.findBranchIdByEmail(email)
                    .orElseThrow(() -> new RuntimeException("Không tìm thấy chi nhánh cho staff: " + email));
        ...
        // ✅ Nếu là VENDOR → chỉ lấy bill theo chi nhánh được gán
